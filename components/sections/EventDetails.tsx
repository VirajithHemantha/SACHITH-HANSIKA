      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-secondary/20 bg-[linear-gradient(180deg,rgba(92,15,29,0.95)_0%,rgba(56,8,17,0.98)_100%)] px-6 py-10 shadow-md shadow-foreground/20 md:px-10 md:py-14">
                    ...
                    <div className="relative z-10">
                      <div className="mb-5 flex justify-center">
                        <motion.div
                          ...
                          className="relative flex h-20 w-20 items-center justify-center rounded-full border border-secondary/25 bg-[linear-gradient(180deg,rgba(245,230,200,0.12),rgba(255,255,255,0.04))]"
                        >
            ...
            {/* Closing line */}
            <motion.p
              className="mt-10 text-center font-serif text-lg italic text-primary/85 md:text-xl"
        ...
        >
          <div className="relative overflow-hidden rounded-[1.6rem] border border-secondary/18 bg-[linear-gradient(180deg,rgba(255,250,244,0.96)_0%,rgba(245,230,200,0.92)_100%)] px-8 py-7 text-center shadow-md shadow-foreground/20">
            <div className="absolute inset-3 rounded-[1.2rem] border border-secondary/10" />
